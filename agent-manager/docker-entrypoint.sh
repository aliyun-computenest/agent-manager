...
const env = {
  ...
  VITE_NATIVE_AGENT_UI_ENABLED: process.env.NATIVE_AGENT_UI_ENABLED || 'false'
}
...
if [ "${NATIVE_AGENT_UI_ENABLED:-false}" = "true" ]; then
  echo "  Native UI preview: http://0.0.0.0:8080/_preview/"
fi
