...
// Agent gateway configuration. The gateway reuses Supabase user tokens.
const AGENT_GATEWAY_DOMAIN = process.env.AGENT_GATEWAY_DOMAIN || env.AGENT_GATEWAY_DOMAIN || ''
const AGENT_GATEWAY_ACCESS_MODE = (process.env.AGENT_GATEWAY_ACCESS_MODE || env.AGENT_GATEWAY_ACCESS_MODE || 'auto').trim().toLowerCase()
...
const DEPLOY_ENVIRONMENT = env.DEPLOY_ENVIRONMENT || 'local-dev'
